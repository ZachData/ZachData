...
(MetastableStateAnalysis)[https://github.com/ZachData/MetastableStateAnalysis]: experiments, clustering, energy functionals, spectral analysis
(research-vm-infra)[https://github.com/ZachData/research-vm-infra]: the AWS pipeline it all runs on
